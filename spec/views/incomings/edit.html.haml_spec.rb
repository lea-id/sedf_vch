...
describe "incomings/edit" do
  before(:each) do
    @incoming = assign(:incoming, stub_model(Incoming,
      :user_id => 1,
      :serial_no1 => 1,
      :doc_no => "MyString",
      :address => "MyString",
  ...
  it "renders the edit incoming form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => incomings_path(@incoming), :method => "post" do
